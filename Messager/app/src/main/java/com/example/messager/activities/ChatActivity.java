...
import com.example.messager.adapters.ChatAdapter;
import com.example.messager.databinding.ActivityChatBinding;
import com.example.messager.models.ChatMessage;
import com.example.messager.models.User;
import com.example.messager.network.ApiClient;
import com.example.messager.network.ApiService;
    ...
    private void sendMessage() {
        ...
        if(!isReceiverAvailable) {
            try {
                ...
                body.put(Constants.REMOET_MSG_REGISTRATION_IDS, tokens);
